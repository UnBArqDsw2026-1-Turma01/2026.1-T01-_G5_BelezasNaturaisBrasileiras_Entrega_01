...
| `4.0` | 23/04/2026 | Inserção da tabela de feedbacks para cada um dos diagramas | [Mateus Magno](https://github.com/mtsmgn0) | [Mário Vinícius](https://github.com/MarioViniciusBC) | **Revisão aprovada:**  Inserção da tabela de feedbacks para cada um dos diagramas com os pontos de revisão considerados validado.   |
| `4.1` | 23/04/2026 | Atualização do histórico de versões com detalhamento das revisões e padronização conforme feedback da equipe. | [Mateus Magno](https://github.com/mtsmgn0) | [Mário Vinícius](https://github.com/MarioViniciusBC) | **Revisão aprovada:** Atualição do histórico de versionamento com a devida padronização validado. |
