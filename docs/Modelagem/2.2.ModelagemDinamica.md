...
![Diagrama de Estados](../assets/fase_2/images/Diagrama_de_Estados-v2.png)

**Mudanças e Melhorias Implementadas na V2:**
* **Legibilidade das Transições:** Substituição dos IDs de requisitos (ex: RF02, RF08) por nomes de eventos amigáveis (ex: "Filtrar por Localidade", "Criar/Editar Trilhas Próprias"), tornando o fluxo mais intuitivo para leitura técnica e de negócio.
* **Ciclo de Vida de Trilhas (RN05/RN06/RF09):** Refinamento da transição entre **Trilha Ativa** e **Trilha Inativa**, explicitando que o fechamento da trilha dispara a distribuição de *badges* e que a reativação é condicionada à alteração da data para o futuro.
* **Sub-estados de Moderação (RF11/RF12):** Detalhamento das ações do Administrador, separando claramente a aprovação de novos organizadores da moderação de denúncias e exclusão de locais.
* **Rastreabilidade de Regras de Negócio:** Inclusão da regra **RN04**, que estabelece a liberação da avaliação do organizador no momento da abertura do chat de inscrição.
...
| `5.2` | 24/04/2026 |Inclusão do elo de rastreabilidade com a Fase 1 (5W2H) na Metodologia. | [Mário Vinícius](https://github.com/MarioViniciusBC) |  |  |
