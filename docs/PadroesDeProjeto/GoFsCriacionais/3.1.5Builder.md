...
classDiagram
    class UserBuilder {
        ...
        -createdAt: Date
        -updatedAt: Date
        +withId(id) UserBuilder
        +withEmail(email) UserBuilder
        +withNome(nome) UserBuilder
        +withRole(role) UserBuilder
        +withFotoPerfil(fotoPerfil) UserBuilder
        +withCreatedAt(createdAt) UserBuilder
        +withUpdatedAt(updatedAt) UserBuilder
        +build() User
    }
