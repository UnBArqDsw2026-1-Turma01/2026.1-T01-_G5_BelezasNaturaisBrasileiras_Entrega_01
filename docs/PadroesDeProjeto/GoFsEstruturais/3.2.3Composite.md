...
classDiagram
    ...
    ILocalizacaoComponent <|.. LocalizacaoFolha
    ILocalizacaoComponent <|.. LocalizacaoComposita
...
```json
{
  "estado": "Minas Gerais",
  "cidades": [
    { "nome": "Alto Paraíso", "pontos": ["Serra da Canastra", "Cachoeira do Campo"] },
...
```json
{
  ...
  "totalPontos": 4,
  "cidades": [
    { "cidade": "Alto Paraíso", "quantidadePontos": 2, "pontos": ["Serra da Canastra", "Cachoeira do Campo"] },
    { "cidade": "Tiradentes",   "quantidadePontos": 2, "pontos": ["Praça Principal", "Igreja Matriz"] }
  ]
}
```
