...
| :----------------------- | :--------------------- | :------------------------------------------------------------------------------------- |
| `Trilha`                 | Originator             | Responsável por criar mementos de si mesma e usar mementos para restaurar seu estado.  |
| `TrilhaMemento`          | Memento                | Objeto de dados imutável que representa um snapshot do estado interno da `Trilha`.     |
| `TrilhaMementoState`     | State (Interface/Tipo) | Define quais atributos da trilha serão preservados no snapshot.                        |
| `TrilhaCaretaker`        | Caretaker (Zelador)    | Gerencia o histórico de mementos, sabendo quando e como salvar ou recuperar snapshots. |
| `FinalizarTrilhaUseCase` | Client / Orquestrador  | Solicita o salvamento do estado antes de realizar a operação de finalização.           |
| `RestaurarTrilhaUseCase` | Client / Orquestrador  | Coordena a recuperação do memento do zelador e a restauração na entidade.              |

## Diagrama de Classes

![diagrama - memento](../../assets/fase_3/memento.svg)
=======
| Classe                   | Papel no Padrão   | Responsabilidade                                                                                     |
| :----------------------- | :---------------- | :--------------------------------------------------------------------------------------------------- |
