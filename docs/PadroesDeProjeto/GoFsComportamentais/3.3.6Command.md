...
classDiagram
  ...
  class EditarTrilhaCommand {
    -trilha Trilha
    -updates EditarTrilhaUpdates
    -snapshot TrilhaSnapshot
    +execute() void
    +undo() void
  }

  class TrilhaCommandHistory {
    -stack ICommand[]
  ...
  class EditarTrilhaUseCase {
    -trilhaRepository ITrilhaRepository
    +execute(id string, organizadorId string, input EditarTrilhaInput) Promise~Trilha~
  }
  ...
  ICommand <|.. EditarTrilhaCommand
  EditarTrilhaCommand --> Trilha : modifica
  EditarTrilhaCommand --> EditarTrilhaUpdates : aplica
  TrilhaCommandHistory --> ICommand : gerencia
  EditarTrilhaUseCase ..> EditarTrilhaCommand : cria e executa
```
