...
- **Telas de Solicitação e Moderação:** Formulário de solicitação de _upgrade_ para Organizador (envio de RG, CPF, justificativa) com exibição de status da aprovação, e modais globais para envio de denúncias (locais, perfis ou comentários).
...
- **Criador de Eventos (Trilhas):** Formulário abrangente de criação e edição de rotas. Inclui a funcionalidade de _popup_ para o cadastro rápido de locais sem a necessidade de interromper o fluxo de criação da trilha.
...
- **Feedback Visual e Estados de Interface:** Mapeamento padronizado de modais de confirmação, mensagens de sucesso/erro via _toast_ e estados de tela críticos (telas de _loading_, _empty states_ para buscas sem resultados e páginas de erro 404/500).
...
| 1.1    | 03/04/2026 | Adição das justificativas de decisão, história de evolução do MVP e formalização do escopo      | [Mateus Magno](https://github.com/mtsmgn0)       | [Vitor Hoffmann](https://github.com/vitor-hoffmann) |
| 1.2    | 03/04/2026 | Inclusão de referências de mercado (concorrentes e inspirações) no texto de Evolução e Desafios | [Mateus Magno](https://github.com/mtsmgn0)       | [Vitor Hoffmann](https://github.com/vitor-hoffmann) |
